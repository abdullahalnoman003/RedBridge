    ...
    return (
        <section className="py-14 bg-gradient-to-br from-gray-50 to-gray-100">
            <div className="max-w-7xl mx-auto px-4">
                <div className="rounded-3xl overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-red-900 text-white grid md:grid-cols-2 shadow-2xl border border-gray-700">
